...
use lib_rustrt::material::{lambertian::Lambertian, metal::Metal, dielectric::Dielectric};
...
const FILE_PATH: &str = "renders/ch11_glass_sphere.ppm";
...
fn main() -> std::io::Result<()>{
    ...
    let material_right = Rc::new(Metal::new(Colour::new(0.8, 0.6, 0.2), 0.4));
